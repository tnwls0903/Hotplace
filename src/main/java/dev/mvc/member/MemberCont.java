...
public class MemberCont {
  ...
  @GetMapping(value="/checkID") // http://localhost:9094/member/checkID?id=admin
  @ResponseBody
...
//    model.addAttribute("ck_passwd_save", "Y");
  ...
  /**
   * 패스워드 변경
   * http://localhost:9094/member/passwd_update_proc?current_passwd=00000000000&passwd=7777
   * @param session
   * @param model
